...
| Address Based Label Provider | Provides a label based on the address of the target asset.<br><br>**Replace With Regex**<br>If checked, the address will be replaced with regex using Pattern and Replacement. |
...
| Address Based Version Provider | Provides a version based on the address of the target asset.<br><br>**Replace With Regex**<br>If checked, the address will be replaced with regex using Pattern and Replacement. |
