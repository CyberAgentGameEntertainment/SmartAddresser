...
{
    internal sealed class VersionComparatorTest
    {
        ...
        public bool Equal(string a, string b)
        {
            ...
            var comparator = new VersionComparator(versionB, VersionComparator.Operator.Equal);
            return comparator.IsSatisfied(versionA);
        }
        ...
        public bool NotEqual(string a, string b)
        {
            var versionA = Version.Create(a);
            var versionB = Version.Create(b);
            var comparator = new VersionComparator(versionB, VersionComparator.Operator.NotEqual);
            return comparator.IsSatisfied(versionA);
        }
        ...
        public bool LessThan(string a, string b)
        {
            var versionA = Version.Create(a);
            var versionB = Version.Create(b);
            var comparator = new VersionComparator(versionB, VersionComparator.Operator.LessThan);
            return comparator.IsSatisfied(versionA);
        }
        ...
        public bool LessThanEqual(string a, string b)
        {
            var versionA = Version.Create(a);
            var versionB = Version.Create(b);
            var comparator = new VersionComparator(versionB, VersionComparator.Operator.LessThanOrEqual);
            return comparator.IsSatisfied(versionA);
        }
        ...
        public bool GreaterThan(string a, string b)
        {
            var versionA = Version.Create(a);
            var versionB = Version.Create(b);
            var comparator = new VersionComparator(versionB, VersionComparator.Operator.GreaterThan);
            return comparator.IsSatisfied(versionA);
        }
        ...
        public bool GreaterThanEqual(string a, string b)
        {
            var versionA = Version.Create(a);
            var versionB = Version.Create(b);
            var comparator = new VersionComparator(versionB, VersionComparator.Operator.GreaterThanOrEqual);
            return comparator.IsSatisfied(versionA);
        }
    }
}
